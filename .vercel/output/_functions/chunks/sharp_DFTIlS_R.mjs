...
import { r as detector } from './remoteProbe_d_ZMbfyW.mjs';
import {
  i as resolveDefaultOutputFormat,
  n as baseService,
  r as parseQuality,
} from './generic__WN66Uui.mjs';
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
  low: 25,
  mid: 50,
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./dist_Bjvh4CL2.mjs')).default;
  } catch {
...
var sharp_default = {
  ...
  async transform(inputBuffer, transformOptions, config) {
    ...
    return {
      data:
        'buffer' in data && data.buffer instanceof SharedArrayBuffer ? new Uint8Array(data) : data,
      format: info.format,
    };
  },
};
...
//# sourceMappingURL=sharp_DFTIlS_R.mjs.map
