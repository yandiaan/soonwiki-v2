import {
  ...
  Z as AstroError,
  u as FailedToFetchRemoteImageDimensions,
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/utils.js
var decoder = new TextDecoder();
var toUTF8String = (input, start = 0, end = input.length) =>
  decoder.decode(input.slice(start, end));
var toHexString = (input, start = 0, end = input.length) =>
...
var readUInt64 = (input, offset, isBigEndian) =>
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/bmp.js
var BMP = {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/ico.js
var TYPE_ICON = 1;
var SIZE_HEADER$1 = 6;
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/cur.js
var TYPE_CURSOR = 2;
var CUR = {
  validate(input) {
    const reserved = readUInt16LE(input, 0);
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/dds.js
var DDS = {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/gif.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/heif.js
var brandMap = {
  avif: 'avif',
  avis: 'avif',
  mif1: 'heif',
  ...
  calculate(input) {
    ...
    while (currentOffset < ipcoEnd) {
      ...
      if (clapBox && clapBox.offset < ipcoEnd && clapBox.size >= 8)
        width = rawWidth - readUInt32BE(input, clapBox.offset + 12);
      images.push({
        height,
        width,
      });
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/icns.js
var SIZE_HEADER = 8;
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/j2c.js
var J2C = {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/jp2.js
var JP2 = {
  validate(input) {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/jpg.js
...
function validateExifBlock(input, index) {
  ...
  if (isBigEndian || byteAlign === LITTLE_ENDIAN_BYTE_ALIGN)
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/utils/bit-reader.js
var BitReader = class {
  byteOffset = 2;
  bitOffset = 0;
  input;
  ...
  getBits(length = 1) {
    ...
    while (bitsRead < length) {
      ...
      if (this.endianness === 'little-endian') {
        ...
        const bits =
          (currentByte & (((1 << bitsToRead) - 1) << (8 - this.bitOffset - bitsToRead))) >>
          (8 - this.bitOffset - bitsToRead);
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/jxl-stream.js
function calculateImageDimension(reader, isSmallImage) {
  if (isSmallImage) return 8 * (1 + reader.getBits(5));
  const extraBits = [9, 13, 18, 30][reader.getBits(2)];
...
function calculateImageWidth(reader, isSmallImage, widthMode, height) {
  ...
  return Math.floor(height * [1, 1.2, 4 / 3, 1.5, 16 / 9, 5 / 4, 2][widthMode - 1]);
}
var JXLStream = {
  validate: (input) => {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/jxl.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/ktx.js
var KTX = {
  validate: (input) => {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/png.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/pnm.js
var PNMTypes = {
  P1: 'pbm/ascii',
  P2: 'pgm/ascii',
  P3: 'ppm/ascii',
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/psd.js
var PSD = {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/svg.js
var svgReg = /<svg\s([^>"']|"[^"]*"|'[^']*')*>/;
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/tga.js
var TGA = {
  validate(input) {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/tiff.js
var CONSTANTS = {
  TAG: {
    WIDTH: 256,
    HEIGHT: 257,
...
function extractTags(input, { isBigEndian, isBigTiff }) {
  ...
  while (temp?.length) {
    ...
    if (
      ...
      tags[code] = readTagValue(temp, type, isBigTiff ? 12 : 8, isBigEndian);
...
var signatures = /* @__PURE__ */ new Set(['49492a00', '4d4d002a', '49492b00', '4d4d002b']);
var TIFF = {
  validate: (input) => {
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/webp.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/types/index.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/detector.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/vendor/image-size/lookup.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/metadata.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/redirectValidation.js
async function fetchWithRedirects(options) {
  const {
    ...
    redirectLimit = 10,
    onMaxRedirectsExceeded = (_u) => /* @__PURE__ */ new Error('Maximum redirect depth exceeded'),
    onMissingLocationHeader = (_s, _u) =>
      /* @__PURE__ */ new Error(`Redirect response ${_s} missing Location header`),
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1._1ba17e19fb65d1b3adcc0713c7cc04ee/node_modules/astro/dist/assets/utils/remoteProbe.js
...
export {
  ...
  fetchWithRedirects as n,
  detector as r,
  inferRemoteSize as t,
};

//# sourceMappingURL=remoteProbe_d_ZMbfyW.mjs.map
